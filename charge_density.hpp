...
namespace charge_density_impl {
    ...
    static constexpr int initial_waypoints = 200; // minimum number of integration intervalls
    ...
    static constexpr double rel_tol = 2e-3; // tolerated relative error in adaptive simpson integration
